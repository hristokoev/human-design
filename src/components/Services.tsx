      ...
      <div className="container">
        <div className="py-32 mx-auto max-w-7xl">
          <div className="flex flex-col">
            ...
            {/* 1 */}
            <div className="mt-36">
              <h3 className="mb-8 text-4xl font-bold">Konzultační služby</h3>
              <p className="text-sm">
                Objevte nové perspektivy a řešení s našimi odbornými
                konzultačními službami, které vám pomohou dosáhnout úspěchu a
                optimalizovat váš potenciál.
              </p>
            </div>
            <motion.div
            ...
            {/* 2 */}
            <div className="mt-36">
              <h3 className="mb-8 text-4xl font-bold">Programy</h3>
              <p className="text-sm">
                Naše programy pro firmy a podnikatele vám pomohou podnikat v
                souladu se sebou a rozvíjet autentické vedení pro úspěch vašeho
                podnikání.
              </p>
            </div>
            <motion.div
            ...
            {/* 3 */}
            <div className="mt-36">
              <h3 className="mb-8 text-4xl font-bold">Přednášky</h3>
              <p className="text-sm">
                Zvýšte úspěch vašeho podnikání s našimi inspirativními
                přednáškami, které poskytují klíčové strategie a know-how pro
                dosažení optimálního růstu a úspěchu vaší firmy.
              </p>
            </div>
            <motion.div
