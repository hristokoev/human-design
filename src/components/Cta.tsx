						...
						<div className="flex min-h-full items-center justify-center p-4 text-center">
							...
							>
								<Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-center align-middle shadow-xl transition-all">
									...
									<Dialog.Title as="h3" className="text-2xl font-bold text-petroleum-900">
										Již brzy!
									</Dialog.Title>

									<div className="mt-4">
										<p className="text-sm text-gray-500">
											E-shop je momentálně ve vývoji. Budeme vás informovat, až bude připraven.
										</p>
									</div>
					...
					<div className="py-24">
						<div className="flex flex-col justify-center gap-y-12 text-center">
							...
							<div className="w-48 mx-auto">
								<button className="w-full btn hover:bg-white/10 shadow-2xl shadow-gold-900/50" onClick={openModal}>E-shop</button>
							</div>
