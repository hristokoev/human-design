...
export default function Hero() {
	...
	return (
		...
		<section className="bg-petrolleum">
			...
			<div className="relative pt-32 pb-48 container min-h-[56rem] overflow-hidden">
				...
				<div className="relative flex flex-col lg:flex-row gap-y-8">
					...
					<div className="lg:w-1/2 lg:pt-12 flex flex-col gap-y-12 order-1 lg:order-0 z-10">
						<div className="flex flex-col font-cuprum leading-none">
							<h1 className="text-[5.5rem] font-bold sm:text-nowrap">
								HUMAN DESIGN
							</h1>
							<h2 className="text-[4.05rem] text-gradient">
						...
						<div className="flex flex-col sm:flex-row items-center gap-6">
							<a href="#" className="btn border-2 border-white hover:bg-white/10 rounded-3xl">Vytvořte si Mapu těla</a>
							<a href="#" className="btn border-2 border-neutral-500 text-neutral-500 hover:bg-neutral-500/10 rounded-3xl">Zájem o info</a>
						</div>
					</div>
				...
				{/* Background */}
				<div className="absolute top-1/3 right-1/2 translate-x-1/2 -translate-y-1/3 lg:right-1/3 lg:translate-x-2/3">
					<img src={BgBrain.src} alt="" className="max-w-[48rem] max-h-[42rem]" />
				</div>

				{/* Chevron */}
				<div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-20 lg:-translate-y-32">
