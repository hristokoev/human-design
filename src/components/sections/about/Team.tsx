							...
							<div className="flex flex-col sm:flex-row gap-8 lg:gap-32">
								...
								<div className="sm:w-2/3 flex flex-col gap-y-4 sm:gap-y-12">
									...
									<div className="relative">
										<svg className="absolute bottom-0 left-0 w-4 h-4 md:w-6 md:h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 14">
										...
										<svg className="absolute top-0 right-0 w-4 h-4 md:w-6 md:h-6 rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 14">
											<path d="M6 0H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v1a3 3 0 0 1-3 3H2a1 1 0 0 0 0 2h1a5.006 5.006 0 0 0 5-5V2a2 2 0 0 0-2-2Zm10 0h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v1a3 3 0 0 1-3 3h-1a1 1 0 0 0 0 2h1a5.006 5.006 0 0 0 5-5V2a2 2 0 0 0-2-2Z" />
										</svg>
									</div>
										...
										<div className="w-full max-w-xl hidden lg:flex flex-col lg:flex-row justify-between">
											{
												item.counters?.map((counter, j) => (
													<div className="flex flex-col items-center" key={j}>
														<span className="text-5xl text-gold font-bold">{counter.number}</span>
									...
									<div className="hidden lg:block mx-auto">
										<button className="btn-lg border-2 bg-gradient-to-r from-[#F0CD5B] to-[#D1A617] hover:brightness-105 text-white text-xl rounded-full">
											Můj příběh
										</button>
									</div>
							...
							<div className="mt-16 sm:mt-24 lg:mt-32 grid md:grid-cols-3 gap-12 md:gap-24">
								{
									item.certificates?.map((certificate, k) => (
										<div className="flex flex-col items-center gap-y-4 text-center" key={k}>
											...
											<h3 className="w-2/3 text-xl text-gold font-bold uppercase">{certificate.title}</h3>
