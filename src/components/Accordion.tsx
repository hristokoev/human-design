...
export default function Accordion({ question, answer, id, active = false }: AccordionProps) {
	...
	return (
		...
		<li className="border-b border-black">
			...
			<h4 className="py-6 font-bold">
				...
				>
					{question}
					<svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg" className={`ml-auto ${accordionOpen && '!rotate-180'}`}>
